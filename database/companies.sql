...
('Bodega PIL','plazuela cala cala','sucursal',1020757027,76970727,'comida',NOW(),NOW()),
('farmacorp','san martin esq. sucre','sucursal',1015447026,4123993,'comida',NOW(),NOW()),
('hipermaxi','Av. America','sucursal',1028627025,,'comida',NOW(),NOW()),
('farmacia nueva zelanda','Av. Ballivian','sucursal',296812023,,'comida',NOW(),NOW()),
('famacorp 12','san martin esq. sucre','sucursal',1015447026,4123993,'comida',NOW(),NOW()),
('fair play 47','25 de mayo','sucursal',1024388029,69412375,'comida',NOW(),NOW());
