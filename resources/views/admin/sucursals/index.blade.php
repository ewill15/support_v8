...
@section('title', ucfirst(trans('common.sucursals')))
@section('content')
<!-- ============================================================== -->
<!-- pageheader -->
<!-- ============================================================== -->
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">{{ ucfirst(trans('common.sucursals')) }}</h2>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}"
                                        class="breadcrumb-link">{{ ucfirst(trans('common.home')) }}</a></li>
                                <li class="breadcrumb-item active">{{ ucfirst(trans('common.list_sucursals')) }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                ...
                <div class="card-body border-top">
                    <a href="{{ url('admin/sucursals/create') }}" class="btn btn-outline-primary float-right">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">{{ucfirst(trans('common.sucursals'))}}</h5>
                    <div class="card-body">
                        <div class="ibox-content">
                            <div class="table-responsive">
                                <form id="paginate" action="{{ url('admin/sucursals') }}">
                                    <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>{{ ucfirst(trans('common.name_sucursal')) }}</th>
                                        ...
                                        <tr class="gradeX {{$item->deleted_at?'text-danger':''}}">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-info btn-sm btn-restore" href="#"
                                                    data-action="restore"
                                                    data-url="{{ asset('admin/sucursals/restore/'.@$item->id)}}"
                                                ...
                                                @else
                                                @if(@$edit)
                                                <a href="{{ url('admin/sucursals/' . @$item->id . '/edit') }}"
                                                ...
                                                @endif
                                                @if(@$recycle)
                                                <a class="btn btn-warning btn-sm btn-recycle" data-toggle-tip="tooltip"
                                                    data-placement="top" title="{{ ucfirst(trans('common.recycle')) }}"
                                                    data-action="recycle"                                                    
                                                    data-url='{{ asset('admin/sucursals/soft/'.@$item->id)}}'
                                                    data-name="{{ $item->name_sucursal }}"
                                                ...
                                                <a href="#" class="btn btn-danger btn-sm" data-toggle-tip="tooltip"
                                                    ...
                                                    data-action="delete"
                                                    data-name="{{ $item->name_warehouse }}" 
                                                    data-url="{{ route('sucursals.destroy', $item->id) }}" 
                                                    data-title-msg="{{ ucfirst(trans('common.msgdelete_register')) }}" 
                                                    data-text-msg="{{ ucfirst(trans('common.msgdelete')) }}"
                                                    data-btn-action="{{ ucwords(trans('common.delete')) }}">
                                ...
                                @include('admin.sucursals.partials.modal-delete')
                                @include('admin.sucursals.partials.modal-recycle')
                                @include('admin.sucursals.partials.modal-restore')
                                <div class="float-left">
                                    {{ $text_pagination }}
                                </div>
                                <div class="float-right">
                                    <div class="btn-group">
                                        {!! $sucursals->appends(request()->except('page'))->render() !!}
                                    </div>
                                </div>
                            </div>
