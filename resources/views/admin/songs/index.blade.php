            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        @include('admin.partials.breadcrumb',[
                            'title'=>ucfirst(trans('common.songs')),
                            'breadcrumbs'=>[
                                'text'=>[
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="card-body border-top">
                        <a href="{{ url('admin/songs/create') }}" class="btn btn-outline-primary float-right">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <!-- ============================================================== -->
                <!-- Form searchs -->   
                    @include('admin.partials.searcher', ['url' => 'admin/songs'])
                <!-- End form searchs --> 
                <!-- ============================================================== -->  
                <!-- ============================================================== --> 
                <!-- Table  --> 
                        ...
                        <div class="table-responsive"> 
                            <table class="table table-register table-striped table-bordered table-hover">                                        
                                ...
                                <tr>
                                    ...
                                    <th>{{ ucfirst(trans('common.title')) }}</th>
                                    <th>{{ ucfirst(trans('common.author')) }}</th>
                                        ...
                                        <td>
                                            <div class="input-group-prepend">
                                                ...
                                                <div class="dropdown-menu">
                                                        <a href="{{ url('admin/songs/' . @$item->id . '/edit') }}" class="dropdown-item">
                                                        ...
                                                        <a class="dropdown-item" href="#"
                                                            ...
                                                            data-url="{{ route('songs.destroy', $item->id) }}" 
                            ...
                            @include('admin.songs.partials.modal-delete')
