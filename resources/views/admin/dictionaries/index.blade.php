            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{ ucfirst(trans('common.dictionaries')) }}</h2>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="card-body border-top">
                        <a href="{{ url('admin/dictionaries/create') }}" class="btn btn-outline-primary float-right">
                ...
                <!-- Table  --> 
                    <div class="ibox-content">
                        <div class="table-responsive"> 
                                        ...
                                        <td>
                                            <div class="input-group-prepend">
                                                ...
                                                <div class="dropdown-menu">
                                                        <a href="{{ url('admin/dictionaries/' . @$item->id . '/edit') }}" class="dropdown-item">
                                                        ...
                                                        <a class="dropdown-item" href="#"
                                                            data-action="delete"
                                                            data-name="{{$item->word}}" 
                                                            data-url="{{ route('dictionaries.destroy', $item->id) }}" 
                            ...
                            @include('admin.dictionaries.partials.modal-delete')
                            <div class="float-left">
                                {{ $text_pagination }}
                            </div>
                            <div class="float-right">                                        
                                <div class="btn-group">
                                  {!! $dictionaries->appends(request()->except('page'))->links() !!}
                                </div>
                            </div>
                        </div>
                    </div>
