            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        @include('admin.partials.breadcrumb',[
                            'title'=>ucfirst(trans('common.accounts')),
                            'breadcrumbs'=>[
                                'text'=>[
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="card-body border-top">
                        <a href="{{ url('admin/accounts/create') }}" class="btn btn-outline-primary float-right">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <!-- ============================================================== -->
                <!-- Form searchs -->   
                    @include('admin.partials.searcher', ['url' => 'admin/accounts'])
                <!-- End form searchs --> 
                <!-- ============================================================== -->  
                <!-- ============================================================== --> 
                <!-- Table  --> 
                    <div class="ibox-content">
                        <div class="table-responsive"> 
                                        ...
                                        <td>
                                            <div class="input-group-prepend">
                                                ...
                                                <div class="dropdown-menu">
                                                        <a href="{{ url('admin/accounts/' . @$item->id . '/edit') }}" class="dropdown-item">
                            ...
                            @include('admin.accounts.partials.modal-delete')
