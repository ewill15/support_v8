        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>{{ucfirst(trans('common.accounts'))}}</h5>
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <form  id="paginate" action="{{ url('admin/accounts') }}">
                            ...
                            @foreach($accounts as $item)                            
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        ...
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['admin/accounts', @$item->id],
                                            'style' => 'display:inline',
                                            'onsubmit' => 'return confirm("ucfirst(trans(\'common.deletes.account\'))")'
                                        ]) !!}
