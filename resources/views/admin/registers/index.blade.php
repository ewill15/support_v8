        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>{{ucfirst(trans('common.register'))}}</h5>
                    <div class="ibox-tools">
                        <a href="{{ url('registers/export') }}">
                            <button type="button" class="btn btn-warning btn-xs">
                                <i class="fa fa-file-excel-o"></i>
                                {{ucfirst(trans('common.full_export'))}}
                            </button>
                        </a>
                        <a href="{{ url('admin/registers/create') }}">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <form  id="paginate" action="{{ url('admin/registers') }}">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th>{{ucwords(trans('common.page'))}}</th>
                            ...
                            @foreach($registers as $item)
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('admin/registers/' . @$item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">{{ucfirst(trans('common.update'))}}</button>
                                        </a> 
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['admin/registers', @$item->id],
                                            'style' => 'display:inline',
                                            'onsubmit' => 'return confirm("ucfirst(trans(\'common.deletes.register\'))")'
                                        ]) !!}
