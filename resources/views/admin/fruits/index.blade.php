...
@section('title', ucfirst(trans('common.fruits')))
@section('content')
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{ ucfirst(trans('common.fruits')) }}</h2>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="card-body border-top">
                        <a href="{{ url('admin/fruits/create') }}" class="btn btn-outline-primary float-right">
                        ...
                        <div class="table-responsive"> 
                            <table class="table table-register table-striped table-bordered table-hover">                                        
                                ...
                                <tr>
                                    ...
                                    <th>{{ ucfirst(trans('common.family')) }}</th>
                                        ...
                                        <td>
                                            <div class="input-group-prepend">
                                                ...
                                                <div class="dropdown-menu">
                                                        <a href="{{ url('admin/fruits/' . @$item->id . '/edit') }}" class="dropdown-item">
                                                        ...
                                                        <a class="dropdown-item" href="#"
                                                            data-action="delete"
                                                            data-name="{{$item->name}}" 
                                                            data-url="{{ route('fruits.destroy', $item->id) }}" 
                            ...
                            @include('admin.fruits.partials.modal-delete')
                            <div class="float-left">
                                {{ $text_pagination }}
                            </div>
                            <div class="float-right">                                        
                                <div class="btn-group">
                                  {!! $fruits->appends(request()->except('page'))->links() !!}
                                </div>
                            </div>
                        </div>
                    </div>
