...
@section('title', ucfirst(trans('common.gusers')))
@section('content')
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{ ucfirst(trans('common.gusers')) }}</h2>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="card-body border-top">
                        <a href="{{ url('admin/gusers/create') }}" class="btn btn-outline-primary float-right">
                    ...
                    <div class="ibox-content">
                        <div class="table-responsive"> 
                            <table class="table table-register table-striped table-bordered table-hover">                                        
                                ...
                                <tbody>
                                @foreach($gusers as $item)
                                    <tr class="gradeX">
                                        <td>{{ @$item->id }}</td>
                                        <td>{{ @$item->first_name }}</td>
                                        <td>{{ @$item->last_name }}</td>
                                        <td>{{ @$item->full_gender }}</td>
                                        <td>
                                            <div class="input-group-prepend">
                                                ...
                                                <div class="dropdown-menu">
                                                        <a href="{{ url('admin/gusers/' . @$item->id . '/edit') }}" class="dropdown-item">
                                                        ...
                                                        <a class="dropdown-item" href="#"
                                                            ...
                                                            data-url="{{ route('gusers.destroy', $item->id) }}" 
                            ...
                            @include('admin.gusers.partials.modal-delete')
                            <div class="float-left">
                                {{ $text_pagination }}
                            </div>
                            <div class="float-right">                                        
                                <div class="btn-group">
                                  {!! $gusers->appends(request()->except('page'))->links() !!}
                                </div>
                            </div>
                        </div>
                    </div>
