        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>{{ucfirst(trans('common.machines'))}}</h5>
                    <div class="ibox-tools">
                        <a href="{{ url('admin/machines/create') }}">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <form  id="paginate" action="{{ url('admin/machines') }}">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                <th>ID</th>                                
                                <th>{{ucfirst(trans('common.processor'))}}</th>
                                <th>IP</th>
                                <th>{{ucfirst(trans('common.os'))}}</th>
                                <th>{{ucfirst(trans('common.mail'))}}</th>
