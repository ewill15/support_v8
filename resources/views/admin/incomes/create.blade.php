            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{ ucfirst(trans('common.income')) }}</h2>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{ ucfirst(trans('common.new_incomes')) }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
                        <h5 class="card-header">{{ucfirst(trans('common.title_income'))}}</h5>
                        <div class="card-body">
                            {!! Form::open([
                                'id'=>'form-income',
                                'route' => 'incomes.store', 
                            ...
                            @include('admin.incomes.partials.form', ['errors' => $errors])
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
