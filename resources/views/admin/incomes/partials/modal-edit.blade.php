<div class="modal fade" id="modal-lg">
  ...
  <div class="modal-content">
    <div class="modal-header">
      <h4 class="modal-title">{{ ucfirst(trans('common.modedit_incomes')) }}</h4>
    ...
    <div class="modal-footer justify-content-between">
      ...
      <button type="button" class="btn btn-primary btn-send-form" data-btn="income">{{ ucfirst(trans('common.update')) }}</button>
    </div>
  </div>
  <!-- /.modal-content -->
</div>
