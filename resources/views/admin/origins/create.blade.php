            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{ ucfirst(trans('common.origin')) }}</h2>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{ ucfirst(trans('common.new_origins')) }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
                        <h5 class="card-header">{{ucfirst(trans('common.title_origin'))}}</h5>
                        <div class="card-body">
                            {!! Form::open([ 
                                'route' => 'origins.store', 
                                'method' => 'POST', 
