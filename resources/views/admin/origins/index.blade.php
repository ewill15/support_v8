                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ ucfirst(trans('common.list_origins')) }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    @if(@$new)
                        <div class="card-body border-top">
                            <a href="{{ url('admin/origins/create') }}" class="btn btn-outline-primary float-right">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">{{ucfirst(trans('common.origins'))}}</h5>
                        <div class="card-body">
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    <form  id="paginate" action="{{ url('admin/origins') }}">
                                        <div class="row">
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            <th>ID</th>
                                            <th>{{ ucfirst(trans('common.origin')) }}</th>
                                        ...
                                        @foreach($origins as $item)
                                            <tr class="gradeX {{$item->deleted_at?'text-danger':''}}">
                                                ...
                                                <td>
                                                    @if ($item->deleted_at)
                                                        @if(@$recycle)
                                                            <a class="btn btn-info btn-sm btn-restore" href="#"
                                                                ...
                                                                data-placement="top" title="{{ ucfirst(trans('common.restore')) }}"
                                                                data-action="restore"
                                                                data-url="{{ asset('admin/origins/restore/'.@$item->id)}}"
                                                                data-title-msg="{{ ucfirst(trans('common.restore_origin')) }}"
                                                    ...
                                                    @else
                                                        @if(@$edit)
                                                            <a href="{{ url('admin/origins/' . @$item->id . '/edit') }}" class="btn btn-primary btn-sm" data-toggle-tip="tooltip" data-placement="top" title="{{ ucfirst(trans('common.update')) }}">                                            
                                                        ...
                                                        @if(@$recycle)
                                                            <a class="btn btn-warning btn-sm btn-recycle" href="#"
                                                                ...
                                                                data-action="recycle"                                                    
                                                                data-url='{{ asset('admin/origins/soft/'.@$item->id)}}'
                                                        ...
                                                        <a href="#" class="btn btn-danger btn-sm" 
                                                            ...
                                                            data-action="delete"
                                                            data-name="{{ $item->name_origin }}"
                                                            data-url="{{ route('origins.destroy', $item->id) }}"
                                                            data-title-msg="{{ ucfirst(trans('common.msgdelete_register')) }}"
                                                            data-text-msg="{{ ucfirst(trans('common.msgdelete')) }}"
                                    ...
                                    @include('admin.origins.partials.modal-delete')
                                    @include('admin.origins.partials.modal-recycle')
                                    @include('admin.origins.partials.modal-restore')
                                    <div class="float-left">
                                        {{ $text_pagination }}
                                    </div>
                                    <div class="float-right">                                        
                                        <div class="btn-group">
                                          {!! $origins->appends(request()->except('page'))->render() !!}
                                        </div>
                                    </div>
                                </div>
