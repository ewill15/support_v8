                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{ ucfirst(trans('common.edit_vouchers')) }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::model($voucher, [ 'route' => ['vouchers.update', $voucher], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal']) !!}
                            ...
                            @include('admin.vouchers.partials.modal-edit')
                         {!! Form::close() !!}
                        </div>
                    </div>
                </div>
