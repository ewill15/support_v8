...
@section('title', ucfirst(trans('common.countries')))
@section('content')
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{ ucfirst(trans('common.countries')) }}</h2>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="card-body border-top">
                        <a href="{{ url('admin/countries/create') }}" class="btn btn-outline-primary float-right">
                        ...
                        <div class="table-responsive"> 
                            <table class="table table-register table-striped table-bordered table-hover">                                        
                                ...
                                <tr>
                                    ...
                                    <th>{{ ucfirst(trans('common.capital')) }}</th>
                                    <th>{{ ucfirst(trans('common.continent')) }}</th>
                                        ...
                                        <td>
                                            <div class="input-group-prepend">
                                                ...
                                                <div class="dropdown-menu">
                                                        <a href="{{ url('admin/countries/' . @$item->id . '/edit') }}" class="dropdown-item">
                                                        ...
                                                        <a class="dropdown-item" href="#"
                                                            data-action="delete"
                                                            data-name="{{$item->name}}" 
                                                            data-url="{{ route('countries.destroy', $item->id) }}" 
                            ...
                            @include('admin.countries.partials.modal-delete')
