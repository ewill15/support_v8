...
@section('title', ucfirst(trans('common.sections')))
@section('content')
        <div class="col-lg-12">
        ...
        <div class="col-lg-10">
            <h2>{{ucfirst(trans('common.sections'))}}</h2>
            <ol class="breadcrumb">
                <li>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>{{ucfirst(trans('common.sections'))}}</h5>
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <form  id="paginate" action="{{ url('admin/sections') }}">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($sections as $item)                            
                                <tr class="gradeX">
                                    ...
                                    <td>{{ @$item->name }}</td>
                                    <td>
                                        <a href="{{ url('admin/sections/' . @$item->id . '/questions') }}">
                                            <button type="submit" class="btn btn-info btn-xs">
                                                {{ucfirst(trans('common.question'))}}
                                                ({{$item->questions->count()}})
                                            </button>
                                        </a> 
                                        <a href="{{ url('admin/sections/' . @$item->id . '/edit') }}">
                                        ...
                                        {!! Form::open([
                                            ...
                                            'onsubmit' => 'return confirm("ucfirst(trans(\'common.deletes.section\'))")'
                                        ]) !!}
                    ...
                    <p>{{ $text_pagination }}</p>
                    {!! $sections->appends(request()->except('page'))->render() !!}
                </div>
            </div>
        </div>
@endsection
