            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{ ucfirst(trans('common.services')) }}</h2>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{ url('/admin/services') }}" class="breadcrumb-link">
                                            {{ ucfirst(trans('common.services')) }}
                                        </a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">{{ ucfirst(trans('common.edit')) }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{-- @include('admin.services.partials.modal-edit') --}}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
