...
@section('title', ucfirst(trans('common.categories')))
@section('content')
<!-- ============================================================== -->
<!-- pageheader -->
<!-- ============================================================== -->
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">{{ ucfirst(trans('common.categories')) }}</h2>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}"
                                        class="breadcrumb-link">{{ ucfirst(trans('common.home')) }}</a></li>
                                <li class="breadcrumb-item active">{{ ucfirst(trans('common.list_categories')) }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                ...
                <div class="card-body border-top">
                    <a href="{{ url('admin/categories/create') }}" class="btn btn-outline-primary float-right">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">{{ucfirst(trans('common.categories'))}}</h5>
                    <div class="card-body">
                        <div class="ibox-content">
                            <div class="table-responsive">
                                <form id="paginate" action="{{ url('admin/categories') }}">
                                    <div class="row">
                                        ...
                                        <tr class="gradeX {{$item->deleted_at?'text-danger':''}}">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-info btn-sm btn-restore" href="#"
                                                    ...
                                                    data-action="restore"
                                                    data-url="{{ asset('admin/categories/restore/'.@$item->id)}}"
                                                    data-title-msg="{{ ucfirst(trans('common.restore_category')) }}"
                                                ...
                                                <a class="btn btn-warning btn-sm btn-recycle" href="#"
                                                    ...
                                                    data-action="recycle"                                                    
                                                    data-url='{{ asset('admin/categories/soft/'.@$item->id)}}'
                                ...
                                @include('admin.categories.partials.modal-recycle')
                                @include('admin.categories.partials.modal-restore')
