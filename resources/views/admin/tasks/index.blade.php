        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>{{ucfirst(trans('common.tasks'))}}</h5>
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <form  id="paginate" action="{{ url('admin/tasks') }}">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th>{{ucfirst(trans('common.machine'))}}</th>
                            ...
                            @foreach($tasks as $item)                            
                                <tr class="gradeX">
                                    ...
                                    <td>{{ $item->machine_id ? @$item->machine->owner : '--'}}</td>
                                    <td>{{ @$item->description }}</td>
                                    <td>
                                        <a href="{{ url('admin/tasks/' . @$item->id . '/edit') }}">
                                        ...
                                        {!! Form::open([
                                            ...
                                            'onsubmit' => 'return confirm("ucfirst(trans(\'common.deletes.task\'))")'
                                        ]) !!}
