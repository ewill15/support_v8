<legend>
    <div class="row">
        ...
        <div class="col-lg-8">
            <fieldset>
                <div class="form-group row {{ $errors->has('name_warehouse') ? 'has-error' : ''}}">
                    {!! Form::label('name_warehouse', ucfirst(trans('common.name_warehouse')), ['class' => 'col-md-4 form-control-label text-md-right']) !!}
                    <div class="col-md-8">
                ...
                <div class="form-group row {{ $errors->has('description') ? 'has-error' : ''}}">
                    {!! Form::label('description', ucfirst(trans('common.description_warehouse')), ['class' => 'col-md-4 form-control-label text-md-right']) !!}
                    <div class="col-md-8">
                ...
                @if(isset($var_dr))
                    <div class="form-group row {{ $errors->has('state_id') ? 'has-error' : ''}}">
                        {!! Form::label('description', ucfirst(trans('common.state_warehouse')), ['class' => 'col-md-4 form-control-label text-md-right']) !!}
