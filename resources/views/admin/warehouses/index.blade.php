        ...
        <div class="row">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ ucfirst(trans('common.list_warehouses')) }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                ...
                <div class="card-body border-top">
                    <a href="{{ url('admin/warehouses/create') }}" class="btn btn-outline-primary float-right">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">{{ucfirst(trans('common.warehouses'))}}</h5>
                    <div class="card-body">
                        <div class="ibox-content">
                            <div class="table-responsive">
                                <form id="paginate" action="{{ url('admin/warehouses') }}">
                                    <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>{{ ucfirst(trans('common.warehouse')) }}</th>
                                        ...
                                        <tr class="gradeX {{$item->deleted_at?'text-danger':''}}">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-info btn-sm btn-restore" href="#"
                                                    data-action="restore"
                                                    data-url="{{ asset('admin/warehouses/restore/'.@$item->id)}}"
                                                    data-title-msg="{{ ucfirst(trans('common.restore_warehouse')) }}" 
                                                ...
                                                <a href="#" class="btn btn-warning btn-sm btn-recycle" data-toggle-tip="tooltip"
                                                    ...
                                                    data-action="recycle"                                                        data-name="{{$item->name_lastname}}"
                                                    data-url='{{ asset('admin/warehouses/soft/'.@$item->id)}}'
                                ...
                                @include('admin.warehouses.partials.modal-delete')
                                @include('admin.warehouses.partials.modal-recycle')
                                @include('admin.warehouses.partials.modal-restore')
