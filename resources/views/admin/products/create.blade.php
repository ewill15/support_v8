...
@section('title', ucfirst(trans('common.create')).'-'.ucfirst(trans('common.products')))
@section('content')
    <!-- ============================================================== -->
    <!-- pageheader -->
    <!-- ============================================================== -->
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ucfirst(trans('common.new_product'))}}
                                    </li>
                                </ol>
                            </nav>
                        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
                        <h5 class="card-header">{{ucfirst(trans('common.create_product'))}}</h5>
                        <div class="card-body">
                            {!! Form::open([
                                'id'=>'form-product',
                            ...
                            @include('admin.products.partials.form', ['errors' => $errors])
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
