...
@section('title', ucfirst(trans('common.types')))
@section('content')
    <!-- ============================================================== -->
    <!-- pageheader -->
    <!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{ ucfirst(trans('common.types')) }}</h2>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}" class="breadcrumb-link">{{ ucfirst(trans('common.home')) }}</a></li>
                                    <li class="breadcrumb-item active">{{ ucfirst(trans('common.list_types')) }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    @if(@$new)
                        <div class="card-body border-top">
                            <a href="{{ url('admin/types/create') }}" class="btn btn-outline-primary float-right">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">{{ucfirst(trans('common.types'))}}</h5>
                        <div class="card-body">
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    <form  id="paginate" action="{{ url('admin/types') }}">
                                        <div class="row">
                                        ...
                                        @foreach($types as $item)
                                            <tr class="gradeX {{$item->deleted_at?'text-danger':''}}">
                                                ...
                                                <td>
                                                    @if ($item->deleted_at)
                                                        @if(@$recycle)
                                                            <a class="btn btn-info btn-sm btn-restore" href="#"
                                                                ...
                                                                data-action="restore"
                                                                data-url="{{ asset('admin/types/restore/'.@$item->id)}}"
                                                                data-title-msg="{{ ucfirst(trans('common.restore_type')) }}"
                                                    ...
                                                    @else
                                                        @if(@$edit)
                                                            <a href="{{ url('admin/types/' . @$item->id . '/edit') }}" class="btn btn-primary btn-sm" data-toggle-tip="tooltip" data-placement="top" title="{{ ucfirst(trans('common.update')) }}">                                            
                                                        ...
                                                        @if(@$recycle)
                                                            <a class="btn btn-warning btn-sm btn-recycle" href="#"
                                                                ...
                                                                data-action="recycle"                                                    
                                                                data-url='{{ asset('admin/types/soft/'.@$item->id)}}'
                                                        ...
                                                        @if(@$trash)
                                                            <a href="#" class="btn btn-danger btn-sm" 
                                                                ...
                                                                data-action="delete"
                                                                data-name="{{ $item->name_type }}"
                                                                data-url="{{ route('types.destroy', $item->id) }}"
                                                                data-title-msg="{{ ucfirst(trans('common.msgdelete_register')) }}"
                                                                data-text-msg="{{ ucfirst(trans('common.msgdelete')) }}">
                                    ...
                                    @include('admin.types.partials.modal-delete')
                                    @include('admin.types.partials.modal-recycle')
                                    @include('admin.types.partials.modal-restore')
