...
@section('title', ucfirst(trans('common.foods')))
@section('content')
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{ ucfirst(trans('common.foods')) }}</h2>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="card-body border-top">
                        <a href="{{ url('admin/foods/create') }}" class="btn btn-outline-primary float-right">
                ...
                <!-- Table  --> 
                    <div class="ibox-content">
                        <div class="table-responsive"> 
                                        ...
                                        <td>
                                            <div class="input-group-prepend">
                                                ...
                                                <div class="dropdown-menu">
                                                        <a href="{{ url('admin/foods/' . @$item->id . '/edit') }}" class="dropdown-item">
                                                        ...
                                                        <a class="dropdown-item" href="#"
                                                            data-action="delete"
                                                            data-name="{{$item->name}}" 
                                                            data-url="{{ route('foods.destroy', $item->id) }}" 
                            ...
                            @include('admin.foods.partials.modal-delete')
