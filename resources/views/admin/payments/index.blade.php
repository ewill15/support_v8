...
@section('title', ucfirst(trans('common.payments')))
@section('content')
    <!-- ============================================================== -->
    <!-- pageheader -->
    <!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{ ucfirst(trans('common.payments')) }}</h2>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}" class="breadcrumb-link">{{ ucfirst(trans('common.home')) }}</a></li>
                                    <li class="breadcrumb-item active">{{ ucfirst(trans('common.list_payments')) }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    @if(@$new)
                        <div class="card-body border-top">
                            <a href="{{ url('admin/payments/create') }}" class="btn btn-outline-primary float-right">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">{{ucfirst(trans('common.payments'))}}</h5>
                        <div class="card-body">
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    <form  id="paginate" action="{{ url('admin/payments') }}">
                                        <div class="row">
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            <th>ID</th>
                                            <th>{{ ucfirst(trans('common.payment')) }}</th>
                                        ...
                                        @foreach($payments as $item)
                                            <tr class="gradeX {{$item->deleted_at?'text-danger':''}}">
                                                ...
                                                <td>
                                                    @if ($item->deleted_at)
                                                        @if(@$recycle)
                                                            <a class="btn btn-info btn-sm btn-restore" href="#"
                                                                data-action="restore"
                                                                data-url="{{ asset('admin/payments/restore/'.@$item->id)}}"
                                                                data-title-msg="{{ ucfirst(trans('common.restore_payment')) }}"
                                                    ...
                                                    @else
                                                        @if(@$edit)
                                                            <a href="{{ url('admin/payments/' . @$item->id . '/edit') }}" class="btn btn-primary btn-sm">                                            
                                                        ...
                                                        @if(@$recycle)
                                                            <a class="btn btn-warning btn-sm btn-recycle" href="#"
                                                                data-action="recycle"                                                    
                                                                data-url='{{ asset('admin/payments/soft/'.@$item->id)}}'
                                                                data-name="{{ $item->name_payment }}"
                                                        ...
                                                        @if(@$trash)
                                                            <a href="#" class="btn btn-danger btn-sm"
                                                                data-action="delete"
                                                                data-name="{{ $item->name_payment }}"
                                                                data-url="{{ route('payments.destroy', $item->id) }}"
                                                                data-title-msg="{{ ucfirst(trans('common.msgdelete_register')) }}"
                                                                data-text-msg="{{ ucfirst(trans('common.msgdelete')) }}">
                                    ...
                                    @include('admin.payments.partials.modal-delete')
                                    @include('admin.payments.partials.modal-recycle')
                                    @include('admin.payments.partials.modal-restore')
