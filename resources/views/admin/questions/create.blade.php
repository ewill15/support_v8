    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{url('admin/sections/'.$section_id.'/questions')}}">{{ucfirst(trans('common.question'))}}</a>
                </li>
                <li class="active">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>
                            ...
                            <small>{{ucfirst(trans('common.section'))}}</small>
                            <small>{{ucfirst(trans('common.question'))}}</small>
                        </h5>
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12" id="app">
                                ...
                                {!! Form::open([
                                    'url' => 'admin/sections/'.$section_id.'/questions',
