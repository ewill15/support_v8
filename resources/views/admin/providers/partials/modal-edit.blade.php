<div class="modal fade" id="modal-lg">
  ...
  <div class="modal-content">
    <div class="modal-header">
      <h4 class="modal-title">{{ ucfirst(trans('common.modedit_providers')) }}</h4>
    ...
    <div class="modal-footer justify-content-between">
      ...
      <button type="button" class="btn btn-primary btn-send-form" data-btn="provider">{{ ucfirst(trans('common.update')) }}</button>
    </div>
  </div>
  <!-- /.modal-content -->
</div>
