...
@section('title', ucfirst(trans('common.legend_clothe')))
@section('content')
        <!-- ============================================================== -->
    <!-- pageheader -->
    <!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        @include('admin.partials.breadcrumb',[
                            'title'=>ucfirst(trans('common.legend_clothe')),
                            'breadcrumbs'=>[
                                'text'=>[
                                    ucfirst(trans('common.legend_clothe'))
                                ],
                                'url'=>[
                                    url('/admin/legend_clothe')
                                ]
                            ],
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="card-body border-top">
                        <a href="{{ url('admin/legend_clothe/create') }}" class="btn btn-outline-primary float-right">
                                            ...
                                            <div class="input-group-prepend">
                                                ...
                                                <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item" href="#"
                                                            ...
                                                            data-url="{{ route('legend_clothe.destroy', $item->id) }}" 
