...
@section('title', ucfirst(trans('common.brands')))
@section('content')
    <!-- ============================================================== -->
    <!-- pageheader -->
    <!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{ ucfirst(trans('common.brands')) }}</h2>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}" class="breadcrumb-link">{{ ucfirst(trans('common.home')) }}</a></li>
                                    <li class="breadcrumb-item active">{{ ucfirst(trans('common.list_brands')) }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    @if(@$new)
                        <div class="card-body border-top">
                            <a href="{{ url('admin/brands/create') }}" class="btn btn-outline-primary float-right">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">{{ucfirst(trans('common.brands'))}}</h5>
                        <div class="card-body">
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    <form  id="paginate" action="{{ url('admin/brands') }}">
                                        <div class="row">
                                        ...
                                        @foreach($brands as $item)
                                            <tr class="gradeX {{$item->deleted_at?'text-danger':''}}">
                                                ...
                                                <td>
                                                    @if ($item->deleted_at)
                                                        @if(@$recycle)
                                                            <a class="btn btn-info btn-sm btn-restore" href="#"
                                                                ...
                                                                data-action="restore"
                                                                data-url="{{ asset('admin/brands/restore/'.@$item->id)}}"
                                                    ...
                                                    @else
                                                        @if(@$edit)
                                                            <a href="{{ url('admin/brands/' . @$item->id . '/edit') }}" class="btn btn-primary btn-sm" data-toggle-tip="tooltip" data-placement="top" title="{{ ucfirst(trans('common.update')) }}">                                            
                                                        ...
                                                        @if(@$recycle)
                                                            <a class="btn btn-warning btn-sm btn-recycle" 
                                                                ...
                                                                data-action="recycle"                 
                                                                data-url='{{ asset('admin/brands/soft/'.@$item->id)}}'
                                                        ...
                                                        <a href="#" class="btn btn-danger btn-sm" 
                                                            data-toggle-tip="tooltip" data-placement="top" title="{{ ucfirst(trans('common.delete')) }}"
                                                            data-action="delete"
                                                            data-name="{{ $item->name_brand }}"
                                                            data-url="{{ route('brands.destroy', $item->id) }}"
                                                            data-title-msg="{{ ucfirst(trans('common.msgdelete_register')) }}"
                                                            data-text-msg="{{ ucfirst(trans('common.msgdelete')) }}"
                                    ...
                                    @include('admin.brands.partials.modal-delete')
                                    @include('admin.brands.partials.modal-recycle')
                                    @include('admin.brands.partials.modal-restore')
