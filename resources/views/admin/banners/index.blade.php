...
@section('title', ucfirst(trans('common.banners')))
@section('content')
<!-- ============================================================== -->
<!-- pageheader -->
<!-- ============================================================== -->
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">{{ ucfirst(trans('common.banners')) }}</h2>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}"
                                        class="breadcrumb-link">{{ ucfirst(trans('common.home')) }}</a></li>
                                <li class="breadcrumb-item active">{{ ucfirst(trans('common.list_banners')) }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                ...
                <div class="card-body border-top">
                    <a href="{{ url('admin/banners/create') }}" class="btn btn-outline-primary float-right">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">{{ucfirst(trans('common.banners'))}}</h5>
                    <div class="card-body">
                        <div class="ibox-content">
                            <div class="table-responsive">
                                <form id="paginate" action="{{ url('admin/banners') }}">
                                    <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>{{ ucfirst(trans('common.banner')) }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX {{$item->deleted_at?'text-danger':''}}">
                                            <td>{{ @$item->id }}</td>
                                            <td><img src="{{ @$item->getImagePathAttribute() }}" alt="image"
                                                    width="75px"></td>
                                            ...
                                            <td>
                                                @if ($item->deleted_at)
                                                @if(@$recycle)
                                                <a class="btn btn-info btn-sm btn-restore" href="#"                                                    href="#"
                                                    data-action="restore"
                                                    data-url="{{ asset('admin/banners/restore/'.@$item->id)}}"
                                                ...
                                                <a class="btn btn-warning btn-sm btn-recycle" data-toggle-tip="tooltip"
                                                    ...
                                                    data-action="recycle"                                                    
                                                    data-url='{{ asset('admin/banners/soft/'.@$item->id)}}'
                                                ...
                                                @endif
                                                    ...
                                                    <a href="#" class="btn btn-danger btn-sm" data-toggle-tip="tooltip"
                                                        ...
                                                        data-action="delete"
                                                        data-name="{{ $item->description }}"
                                                        data-url="{{ route('banners.destroy', $item->id) }}"
                                                        data-title-msg="{{ ucfirst(trans('common.msgdelete_register')) }}"
                                                        data-text-msg="{{ ucfirst(trans('common.msgdelete')) }}"
                                ...
                                @include('admin.banners.partials.modal-delete')
                                @include('admin.banners.partials.modal-recycle')
                                @include('admin.banners.partials.modal-restore')
