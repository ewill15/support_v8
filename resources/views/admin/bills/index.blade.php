        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>{{ucfirst(trans('common.bills'))}}</h5>
                    <div class="ibox-tools">
                        <a href="{{ url('bills/export') }}">
                            <button type="button" class="btn btn-warning btn-xs">
                                <i class="fa fa-file-excel-o"></i>
                                {{ucfirst(trans('common.full_export'))}}
                            </button>
                        </a>
                        <a href="{{ url('admin/bills/create') }}">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <form  id="paginate" action="{{ url('admin/bills') }}">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                <th>ID</th>                                
                                <th>{{ucfirst(trans('common.invoice_number'))}}</th>
                                <th>{{ucfirst(trans('common.company'))}}</th>
                                <th>{{ucwords(trans('common.control_code'))}}</th>
                            ...
                            @foreach($bills as $item)                            
                                <tr class="gradeX">
                                    ...
                                    <td>{{ @$item->price }}</td>
                                    <td>
                                        <a href="{{ url('admin/bills/' . @$item->id . '/edit') }}">
                                        ...
                                        {!! Form::open([
                                            ...
                                            'onsubmit' => 'return confirm("ucfirst(trans(\'common.deletes.bill\'))")'
                                        ]) !!}
